...
Extraia os dados e responda SOMENTE em JSON puro, sem markdown, sem texto extra.
Se nao encontrar um campo use string vazia "".
{"supplier":"razao social do fornecedor","nfNumber":"numero da nota so digitos","date":"data YYYY-MM-DD","feedType":"tipo de racao (Extrusada flutuante, semi-afundante, Peletizada...)","feedBrand":"marca ou fabricante","proteinPct":"% proteina bruta — escolha entre: 45%, 40%, 36%, 32%, 28%","bags":"sacos de 25kg como numero inteiro (se vier em kg divida por 25)","totalValue":"valor total so o numero sem R$","costPerBag":"valor por saco 25kg","payMethod":"PIX, A vista, Boleto 30d, Boleto 60d, Cartao ou Transferencia","obs":"vencimento frete ou observacoes"}`;
